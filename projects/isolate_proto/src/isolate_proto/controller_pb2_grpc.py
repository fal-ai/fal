...
class IsolateController(object):
    ...
    def InteractiveRun(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/controller.IsolateController/InteractiveRun',
    ...
    def StopRunner(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/controller.IsolateController/StopRunner',
    ...
    def KillRunner(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/controller.IsolateController/KillRunner',
    ...
    def ListRunners(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/controller.IsolateController/ListRunners',
    ...
    def ShellRunner(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/controller.IsolateController/ShellRunner',
