...
class CreateUserKeyRequest(google.protobuf.message.Message):
    ...
    Optional so the server can tell an explicit ADMIN apart from an unset
    scope; a pre-v2 client leaves it off the wire and still means ADMIN.
    """
    alias: builtins.str
...
class KeyPolicy(google.protobuf.message.Message):
    ...
    deferred; only a permission list is supported for now.
    """
