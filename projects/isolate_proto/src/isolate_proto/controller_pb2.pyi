...
class ListRunnersRequest(google.protobuf.message.Message):
    ...
    LIST_PENDING_FIELD_NUMBER: builtins.int
    START_TIME_FIELD_NUMBER: builtins.int
    INCLUDE_LEASES_FIELD_NUMBER: builtins.int
    list_pending: builtins.bool
    @property
    def start_time(self) -> google.protobuf.timestamp_pb2.Timestamp: ...
    include_leases: builtins.bool
    def __init__(
        self,
        *,
        list_pending: builtins.bool | None = ...,
        start_time: google.protobuf.timestamp_pb2.Timestamp | None = ...,
        include_leases: builtins.bool | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["_include_leases", b"_include_leases", "_list_pending", b"_list_pending", "_start_time", b"_start_time", "include_leases", b"include_leases", "list_pending", b"list_pending", "start_time", b"start_time"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["_include_leases", b"_include_leases", "_list_pending", b"_list_pending", "_start_time", b"_start_time", "include_leases", b"include_leases", "list_pending", b"list_pending", "start_time", b"start_time"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_include_leases", b"_include_leases"]) -> typing_extensions.Literal["include_leases"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_list_pending", b"_list_pending"]) -> typing_extensions.Literal["list_pending"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing_extensions.Literal["_start_time", b"_start_time"]) -> typing_extensions.Literal["start_time"] | None: ...
