...
class RunnerInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["expiration_countdown", b"expiration_countdown", "in_flight_requests", b"in_flight_requests", "runner_id", b"runner_id", "uptime", b"uptime"]) -> None: ...
