...
class HostedRun(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_environment_name", b"_environment_name", "_machine_requirements", b"_machine_requirements", "_setup_func", b"_setup_func", "environment_name", b"environment_name", "environments", b"environments", "files", b"files", "function", b"function", "machine_requirements", b"machine_requirements", "setup_func", b"setup_func"]) -> None: ...
    @typing.overload
...
class RegisterApplicationRequest(google.protobuf.message.Message):
    ...
    ENABLE_CDN_AL_FIELD_NUMBER: builtins.int
    ...
    def __init__(
        ...
        *,
        ...
        enable_cdn_al: builtins.bool | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["_application_name", b"_application_name", "_auth_mode", b"_auth_mode", "_deployment_strategy", b"_deployment_strategy", "_enable_cdn_al", b"_enable_cdn_al", "_environment_name", b"_environment_name", "_health_check_config", b"_health_check_config", "_health_check_path", b"_health_check_path", "_machine_requirements", b"_machine_requirements", "_max_concurrency", b"_max_concurrency", "_metadata", b"_metadata", "_private_logs", b"_private_logs", "_scale", b"_scale", "_setup_func", b"_setup_func", "_source_code", b"_source_code", "application_name", b"application_name", "auth_mode", b"auth_mode", "deployment_strategy", b"deployment_strategy", "enable_cdn_al", b"enable_cdn_al", "environment_name", b"environment_name", "function", b"function", "health_check_config", b"health_check_config", "health_check_path", b"health_check_path", "machine_requirements", b"machine_requirements", "max_concurrency", b"max_concurrency", "metadata", b"metadata", "private_logs", b"private_logs", "scale", b"scale", "setup_func", b"setup_func", "source_code", b"source_code"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_application_name", b"_application_name", "_auth_mode", b"_auth_mode", "_deployment_strategy", b"_deployment_strategy", "_enable_cdn_al", b"_enable_cdn_al", "_environment_name", b"_environment_name", "_health_check_config", b"_health_check_config", "_health_check_path", b"_health_check_path", "_machine_requirements", b"_machine_requirements", "_max_concurrency", b"_max_concurrency", "_metadata", b"_metadata", "_private_logs", b"_private_logs", "_scale", b"_scale", "_setup_func", b"_setup_func", "_source_code", b"_source_code", "application_name", b"application_name", "auth_mode", b"auth_mode", "deployment_strategy", b"deployment_strategy", "enable_cdn_al", b"enable_cdn_al", "environment_name", b"environment_name", "environments", b"environments", "files", b"files", "function", b"function", "health_check_config", b"health_check_config", "health_check_path", b"health_check_path", "machine_requirements", b"machine_requirements", "max_concurrency", b"max_concurrency", "metadata", b"metadata", "private_logs", b"private_logs", "scale", b"scale", "setup_func", b"setup_func", "skip_retry_conditions", b"skip_retry_conditions", "source_code", b"source_code"]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_enable_cdn_al", b"_enable_cdn_al"]) -> typing.Literal["enable_cdn_al"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_environment_name", b"_environment_name"]) -> typing.Literal["environment_name"] | None: ...
    @typing.overload
...
class SetAliasRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_auth_mode", b"_auth_mode", "_environment_name", b"_environment_name", "alias", b"alias", "auth_mode", b"auth_mode", "environment_name", b"environment_name", "revision", b"revision"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_auth_mode", b"_auth_mode"]) -> typing.Literal["auth_mode"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["_environment_name", b"_environment_name"]) -> typing.Literal["environment_name"] | None: ...
