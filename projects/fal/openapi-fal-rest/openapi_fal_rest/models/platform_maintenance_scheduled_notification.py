...
T = TypeVar("T", bound="PlatformMaintenanceScheduledNotification")


@_attrs_define
class PlatformMaintenanceScheduledNotification:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        platform_maintenance_scheduled_notification = cls(
            notification_id=notification_id,
            created_at=created_at,
            category=category,
            user_id=user_id,
        ...
        platform_maintenance_scheduled_notification.additional_properties = d
        return platform_maintenance_scheduled_notification
