...
from ..models.document_qualify_request_media_type import DocumentQualifyRequestMediaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="DocumentQualifyRequest")


@_attrs_define
class DocumentQualifyRequest:
    """
    Attributes:
        request_id (Union[Unset, UUID]):
        image_url (Union[Unset, str]):
        media_url (Union[Unset, str]):
        media_type (Union[Unset, DocumentQualifyRequestMediaType]):
    ...
    media_type: Union[Unset, DocumentQualifyRequestMediaType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_media_type, Unset):
            ...
            media_type = DocumentQualifyRequestMediaType(_media_type)

        prompt = d.pop("prompt", UNSET)

        document_qualify_request = cls(
        ...
        document_qualify_request.additional_properties = d
        return document_qualify_request
