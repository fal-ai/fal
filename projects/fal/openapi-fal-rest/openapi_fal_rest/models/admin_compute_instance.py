...
T = TypeVar("T", bound="AdminComputeInstance")


@_attrs_define
class AdminComputeInstance:
    """
    Attributes:
        id (UUID):
        instance_type (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        admin_compute_instance.additional_properties = d
        return admin_compute_instance
