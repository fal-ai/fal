...
T = TypeVar("T", bound="PlatformAppDeletedPayload")


@_attrs_define
class PlatformAppDeletedPayload:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        platform_app_deleted_payload = cls(
            application=application,
            full_application=full_application,
            environment=environment,
        )

        platform_app_deleted_payload.additional_properties = d
        return platform_app_deleted_payload
