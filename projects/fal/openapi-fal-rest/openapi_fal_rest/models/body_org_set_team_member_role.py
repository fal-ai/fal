...
T = TypeVar("T", bound="BodyOrgSetTeamMemberRole")


@_attrs_define
class BodyOrgSetTeamMemberRole:
    """
    Attributes:
        role (TeamRole):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        body_org_set_team_member_role = cls(
            role=role,
            policy_role=policy_role,
        )

        body_org_set_team_member_role.additional_properties = d
        return body_org_set_team_member_role
