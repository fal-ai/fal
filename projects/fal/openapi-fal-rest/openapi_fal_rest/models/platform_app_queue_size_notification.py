...
T = TypeVar("T", bound="PlatformAppQueueSizeNotification")


@_attrs_define
class PlatformAppQueueSizeNotification:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        platform_app_queue_size_notification = cls(
            notification_id=notification_id,
            created_at=created_at,
            category=category,
            user_id=user_id,
        ...
        platform_app_queue_size_notification.additional_properties = d
        return platform_app_queue_size_notification
