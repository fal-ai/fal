...
T = TypeVar("T", bound="UserKeyDetailedInfo")


@_attrs_define
class UserKeyDetailedInfo:
    """
    Attributes:
        user_id (str):
        key_id (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        user_key_detailed_info.additional_properties = d
        return user_key_detailed_info
