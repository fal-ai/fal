...
T = TypeVar("T", bound="PolicyKeyInfo")
...
class PolicyKeyInfo:
    ...
    Attributes:
        ...
        mode (Union[Literal['policy'], Unset]):  Default: 'policy'.
    """
    ...
    mode: Union[Literal["policy"], Unset] = "policy"
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        mode = cast(Union[Literal["policy"], Unset], d.pop("mode", UNSET))
        if mode != "policy" and not isinstance(mode, Unset):
            raise ValueError(f"mode must match const 'policy', got '{mode}'")
        ...
        policy_key_info.additional_properties = d
        return policy_key_info
