...
T = TypeVar("T", bound="PlatformWelcomeWithoutCreditsNotification")


@_attrs_define
class PlatformWelcomeWithoutCreditsNotification:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        platform_welcome_without_credits_notification = cls(
            notification_id=notification_id,
            created_at=created_at,
            category=category,
            user_id=user_id,
        ...
        platform_welcome_without_credits_notification.additional_properties = d
        return platform_welcome_without_credits_notification
