...
T = TypeVar("T", bound="CdnObjectAclRuleResponse")


@_attrs_define
class CdnObjectAclRuleResponse:
    """
    Attributes:
        user (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        cdn_object_acl_rule_response = cls(
            user=user,
            decision=decision,
        )

        cdn_object_acl_rule_response.additional_properties = d
        return cdn_object_acl_rule_response
