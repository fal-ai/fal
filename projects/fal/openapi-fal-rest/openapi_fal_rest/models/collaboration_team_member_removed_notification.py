...
T = TypeVar("T", bound="CollaborationTeamMemberRemovedNotification")


@_attrs_define
class CollaborationTeamMemberRemovedNotification:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        collaboration_team_member_removed_notification = cls(
            notification_id=notification_id,
            created_at=created_at,
            category=category,
            user_id=user_id,
        ...
        collaboration_team_member_removed_notification.additional_properties = d
        return collaboration_team_member_removed_notification
