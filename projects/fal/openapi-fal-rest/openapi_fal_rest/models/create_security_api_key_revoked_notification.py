...
T = TypeVar("T", bound="CreateSecurityApiKeyRevokedNotification")


@_attrs_define
class CreateSecurityApiKeyRevokedNotification:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_security_api_key_revoked_notification = cls(
            channels=channels,
            subcategory=subcategory,
            payload=payload,
        )

        create_security_api_key_revoked_notification.additional_properties = d
        return create_security_api_key_revoked_notification
