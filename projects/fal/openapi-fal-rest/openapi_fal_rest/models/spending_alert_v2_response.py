...
T = TypeVar("T", bound="SpendingAlertV2Response")


@_attrs_define
class SpendingAlertV2Response:
    """
    Attributes:
        id (str):
        user_id (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        spending_alert_v2_response = cls(
            id=id,
            user_id=user_id,
            subject_type=subject_type,
            subject_id=subject_id,
        ...
        spending_alert_v2_response.additional_properties = d
        return spending_alert_v2_response
