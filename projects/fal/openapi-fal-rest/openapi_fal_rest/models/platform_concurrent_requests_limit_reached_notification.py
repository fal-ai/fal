...
T = TypeVar("T", bound="PlatformConcurrentRequestsLimitReachedNotification")


@_attrs_define
class PlatformConcurrentRequestsLimitReachedNotification:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        platform_concurrent_requests_limit_reached_notification = cls(
            notification_id=notification_id,
            created_at=created_at,
            category=category,
            user_id=user_id,
        ...
        platform_concurrent_requests_limit_reached_notification.additional_properties = d
        return platform_concurrent_requests_limit_reached_notification
