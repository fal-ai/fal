...
T = TypeVar("T", bound="ProvisionPaymentResponse")


@_attrs_define
class ProvisionPaymentResponse:
    """
    Attributes:
        timestamp (str):
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        provision_payment_response = cls(
            timestamp=timestamp,
            balances=balances,
        )

        provision_payment_response.additional_properties = d
        return provision_payment_response
