...
T = TypeVar("T", bound="PlatformComputeInsufficientCapacityNotification")


@_attrs_define
class PlatformComputeInsufficientCapacityNotification:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        platform_compute_insufficient_capacity_notification = cls(
            notification_id=notification_id,
            created_at=created_at,
            category=category,
            user_id=user_id,
        ...
        platform_compute_insufficient_capacity_notification.additional_properties = d
        return platform_compute_insufficient_capacity_notification
