...
if TYPE_CHECKING:
    from ..models.update_app_notification_settings_request_channel_preferences_override import (
        UpdateAppNotificationSettingsRequestChannelPreferencesOverride,
    )


T = TypeVar("T", bound="UpdateAppNotificationSettingsRequest")


@_attrs_define
class UpdateAppNotificationSettingsRequest:
    """
    Attributes:
        ...
        channel_preferences_override (Union[Unset, UpdateAppNotificationSettingsRequestChannelPreferencesOverride]):
    """
    ...
    channel_preferences_override: Union[Unset, "UpdateAppNotificationSettingsRequestChannelPreferencesOverride"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        if isinstance(_channel_preferences_override, Unset):
            ...
            channel_preferences_override = UpdateAppNotificationSettingsRequestChannelPreferencesOverride.from_dict(
                _channel_preferences_override
            )

        update_app_notification_settings_request = cls(
        ...
        update_app_notification_settings_request.additional_properties = d
        return update_app_notification_settings_request
