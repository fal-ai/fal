...
from ..models.admin_runner_info_owner import AdminRunnerInfoOwner
from ..models.admin_runner_info_state import AdminRunnerInfoState
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.admin_runner_info_leases_metadata_item import AdminRunnerInfoLeasesMetadataItem
    from ..models.runner_timing_info import RunnerTimingInfo


T = TypeVar("T", bound="AdminRunnerInfo")


@_attrs_define
class AdminRunnerInfo:
    """
    Attributes:
        runner_id (str):
        state (AdminRunnerInfoState):
        machine_type (str):
        region (str):
        node_id (str):
        owner (AdminRunnerInfoOwner):
        operator_in_flight_requests (int):
        operator_active_lease_count (int):
        operator_missing_lease_count (int):
        operator_has_unleased_inflight (bool):
        leases_metadata (list['AdminRunnerInfoLeasesMetadataItem']):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        operator_in_flight_requests = self.operator_in_flight_requests

        operator_active_lease_count = self.operator_active_lease_count

        operator_missing_lease_count = self.operator_missing_lease_count

        operator_has_unleased_inflight = self.operator_has_unleased_inflight

        leases_metadata = []
        for leases_metadata_item_data in self.leases_metadata:
            leases_metadata_item = leases_metadata_item_data.to_dict()
            leases_metadata.append(leases_metadata_item)
        ...
        field_dict.update(
            {
                ...
                "node_id": node_id,
                "owner": owner,
                "operator_in_flight_requests": operator_in_flight_requests,
                "operator_active_lease_count": operator_active_lease_count,
                "operator_missing_lease_count": operator_missing_lease_count,
                "operator_has_unleased_inflight": operator_has_unleased_inflight,
                "leases_metadata": leases_metadata,
            }
        )
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        state = AdminRunnerInfoState(d.pop("state"))
        ...
        owner = AdminRunnerInfoOwner(d.pop("owner"))

        operator_in_flight_requests = d.pop("operator_in_flight_requests")

        operator_active_lease_count = d.pop("operator_active_lease_count")

        operator_missing_lease_count = d.pop("operator_missing_lease_count")

        operator_has_unleased_inflight = d.pop("operator_has_unleased_inflight")

        leases_metadata = []
        _leases_metadata = d.pop("leases_metadata")
        for leases_metadata_item_data in _leases_metadata:
            leases_metadata_item = AdminRunnerInfoLeasesMetadataItem.from_dict(leases_metadata_item_data)
        ...
        admin_runner_info.additional_properties = d
        return admin_runner_info
