...
T = TypeVar("T", bound="PlatformAppStartupTimeoutPayload")


@_attrs_define
class PlatformAppStartupTimeoutPayload:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        platform_app_startup_timeout_payload = cls(
        ...
        platform_app_startup_timeout_payload.additional_properties = d
        return platform_app_startup_timeout_payload
