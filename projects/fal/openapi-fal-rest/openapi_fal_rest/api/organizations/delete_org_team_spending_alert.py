...
def sync_detailed(
    ...
    *,
    ...
    """Delete Org Team Spending Alert

     Delete a spending alert for a team within the organization.

    Org admins can delete spending alerts for any team within their organization.
