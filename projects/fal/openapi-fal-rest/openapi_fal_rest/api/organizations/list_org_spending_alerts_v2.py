...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/organizations/spending-alerts-v2",
        "params": params,
    }
...
) -> Optional[Union[HTTPValidationError, list["OrgSpendingAlertV2Response"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = OrgSpendingAlertV2Response.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, list["OrgSpendingAlertV2Response"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, list['OrgSpendingAlertV2Response']]
    """
