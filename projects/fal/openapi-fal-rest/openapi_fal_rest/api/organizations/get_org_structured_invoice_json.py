...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organizations/invoice/{invoice_id}/json",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get Org Structured Invoice Json Endpoint

     Get structured invoice data for an organization invoice.

    Requires org admin or billing role.

    Includes a team_breakdown section showing usage totals per team
