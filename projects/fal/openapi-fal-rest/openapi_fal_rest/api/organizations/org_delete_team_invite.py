...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/organizations/teams/{team_user_str}/invites/{code}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Org Delete Team Invite

     Delete a pending invite for a team within the organization.

    Org admins can delete pending invites for any team within their organization.
