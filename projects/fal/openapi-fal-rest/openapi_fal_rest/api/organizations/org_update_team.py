...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/organizations/teams/{team_user_str}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Org admins can update properties for any team within their organization.
    ...
    Args:
        team_user_str (str):
        body (UpdateTeamRequest): Request to update a team's properties.
