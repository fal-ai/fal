...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/billing/v2/invoice/{invoice_id}/json",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get Structured Invoice Json

     Get structured invoice data in JSON format.
    ...
    Note: For team breakdown by user, use the organization invoice endpoint instead.
