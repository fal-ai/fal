...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/billing/v2/invoice/{invoice_id}/csv",
    }
...
def sync_detailed(
    ...
    *,
    ...
    r"""Get Structured Invoice Csv

     Get structured invoice data in CSV format.
    ...
    Note: The structured data is enriched with database information
    (key aliases, user details) but the CSV output maintains the
    same columns for backwards compatibility.
