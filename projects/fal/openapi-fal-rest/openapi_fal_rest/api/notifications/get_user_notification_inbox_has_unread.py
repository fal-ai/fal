...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/notifications/inbox/has-unread",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Get User Notification Inbox Has Unread

     Cheap unread status for header badges / poll-based UIs.

    Does NOT materialize system notifications -- this endpoint is polled at
    high rates and we accept stale-by-one-tick status rather than writing on
    every poll. ``/inbox`` will materialize on next load.
