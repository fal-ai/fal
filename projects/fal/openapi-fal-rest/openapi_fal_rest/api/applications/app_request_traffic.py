...
from ...models.app_request_traffic_request_type import AppRequestTrafficRequestType
...
def _get_kwargs(
    ...
    *,
    ...
    request_type: Union[Unset, AppRequestTrafficRequestType] = AppRequestTrafficRequestType.HTTP,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/applications/{app_user_id}/{app_alias_or_id}/request-traffic",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        request_type (Union[Unset, AppRequestTrafficRequestType]):  Default:
            AppRequestTrafficRequestType.HTTP.
