...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/applications/{app_user_id}/{app_alias}/notifications/inbox/has-unread",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get App Notification Inbox Has Unread

     App-scoped unread status. Poll-friendly; no materialization side effect.
