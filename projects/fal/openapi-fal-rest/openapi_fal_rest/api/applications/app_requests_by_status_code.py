...
from ...models.app_requests_by_status_code_request_type import AppRequestsByStatusCodeRequestType
...
def _get_kwargs(
    ...
    *,
    ...
    request_type: Union[Unset, AppRequestsByStatusCodeRequestType] = AppRequestsByStatusCodeRequestType.HTTP,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/applications/{app_user_id}/{app_alias_or_id}/requests-by-status-code",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        end_time (datetime.datetime):
        granularity (TimingGranularity):
        request_type (Union[Unset, AppRequestsByStatusCodeRequestType]):  Default:
            AppRequestsByStatusCodeRequestType.HTTP.
