...
from ...models.filter_requests_by_endpoints_sort_by import FilterRequestsByEndpointsSortBy
from ...models.filter_requests_by_endpoints_status import FilterRequestsByEndpointsStatus
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, FilterRequestsByEndpointsStatus] = UNSET,
    request_id: Union[Unset, UUID] = UNSET,
    error_type: Union[Unset, str] = UNSET,
    payloads: Union[Unset, bool] = False,
    sort_by: Union[Unset, FilterRequestsByEndpointsSortBy] = FilterRequestsByEndpointsSortBy.ENDED_AT,
...
def sync_detailed(
    *,
    ...
    """Filter Requests By Endpoints

     Filter gateway requests by multiple endpoints.

    Similar to filter_requests_by_endpoint but accepts multiple endpoints.
    Results are scoped to the authenticated user.

    Args:
        endpoints (list[str]): List of endpoints to filter by
        start_time (Union[Unset, datetime.datetime]):
        end_time (Union[Unset, datetime.datetime]):
        status (Union[Unset, FilterRequestsByEndpointsStatus]):
        request_id (Union[Unset, UUID]):
        error_type (Union[Unset, str]):
        payloads (Union[Unset, bool]):  Default: False.
        sort_by (Union[Unset, FilterRequestsByEndpointsSortBy]):  Default:
            FilterRequestsByEndpointsSortBy.ENDED_AT.
