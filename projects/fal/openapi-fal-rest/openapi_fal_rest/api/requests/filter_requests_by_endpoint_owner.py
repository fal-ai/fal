...
from ...models.filter_requests_by_endpoint_owner_sort_by import FilterRequestsByEndpointOwnerSortBy
from ...models.filter_requests_by_endpoint_owner_status import FilterRequestsByEndpointOwnerStatus
...
def _get_kwargs(
    *,
    ...
    status: Union[Unset, FilterRequestsByEndpointOwnerStatus] = UNSET,
    request_id: Union[Unset, UUID] = UNSET,
    error_type: Union[Unset, str] = UNSET,
    payloads: Union[Unset, bool] = False,
    sort_by: Union[Unset, FilterRequestsByEndpointOwnerSortBy] = FilterRequestsByEndpointOwnerSortBy.ENDED_AT,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/requests/owner/by-endpoint",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Filter Requests By Endpoint Owner

    Args:
        endpoint (str):
        start_time (Union[Unset, datetime.datetime]):
        end_time (Union[Unset, datetime.datetime]):
        status (Union[Unset, FilterRequestsByEndpointOwnerStatus]):
        request_id (Union[Unset, UUID]):
        error_type (Union[Unset, str]):
        payloads (Union[Unset, bool]):  Default: False.
        sort_by (Union[Unset, FilterRequestsByEndpointOwnerSortBy]):  Default:
            FilterRequestsByEndpointOwnerSortBy.ENDED_AT.
