...
def _get_kwargs(
    *,
    ...
    used_endpoints: Union[Unset, list[str]] = UNSET,
    ...
    json_used_endpoints: Union[Unset, list[str]] = UNSET
    if not isinstance(used_endpoints, Unset):
        json_used_endpoints = used_endpoints

    params["used_endpoints"] = json_used_endpoints
...
def sync_detailed(
    *,
    ...
    """Get User Workflows V2

    Args:
        search (Union[Unset, str]): Search by workflow name
        used_endpoints (Union[Unset, list[str]]): Filter by endpoints used in the workflow
        group_id (Union[Unset, str]): Filter by group ID
