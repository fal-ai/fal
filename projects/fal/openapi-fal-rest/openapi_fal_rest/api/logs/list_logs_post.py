...
from ...models.list_logs_post_run_source import ListLogsPostRunSource
...
def _get_kwargs(
    *,
    ...
    run_source: Union[Unset, ListLogsPostRunSource] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        run_source (Union[Unset, ListLogsPostRunSource]):
