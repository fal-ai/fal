...
from ...models.list_logs_run_source import ListLogsRunSource
...
def _get_kwargs(
    *,
    ...
    run_source: Union[Unset, ListLogsRunSource] = UNSET,
...
def sync_detailed(
    *,
    ...
    """List Logs
     ...
     This endpoint is deprecated, use the POST version.
    ...
    Args:
        ...
        run_source (Union[Unset, ListLogsRunSource]):
