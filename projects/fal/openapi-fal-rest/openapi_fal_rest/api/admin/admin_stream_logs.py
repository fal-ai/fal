...
from ...models.admin_stream_logs_run_source import AdminStreamLogsRunSource
...
def _get_kwargs(
    *,
    ...
    run_source: Union[Unset, AdminStreamLogsRunSource] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        run_source (Union[Unset, AdminStreamLogsRunSource]):
