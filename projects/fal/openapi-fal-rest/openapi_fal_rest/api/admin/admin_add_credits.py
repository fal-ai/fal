...
from ...models.credit_reason import CreditReason
...
def _get_kwargs(
    *,
    user_id: str,
    amount: int,
    reason: Union[Unset, CreditReason] = UNSET,
    ...
    json_reason: Union[Unset, str] = UNSET
...
def sync_detailed(
    *,
    ...
    Args:
        user_id (str):
        amount (int):
        reason (Union[Unset, CreditReason]):
