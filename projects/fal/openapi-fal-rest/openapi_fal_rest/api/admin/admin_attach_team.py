...
from ...models.body_admin_attach_team import BodyAdminAttachTeam
...
def _get_kwargs(
    org_user_str: str,
    *,
    body: BodyAdminAttachTeam,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/admin/organizations/{org_user_str}/actions/attach-team",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Attach Team
     ...
     Attach an existing standalone team to the organization.

    Use update-team-auth-provider to configure SSO separately.
