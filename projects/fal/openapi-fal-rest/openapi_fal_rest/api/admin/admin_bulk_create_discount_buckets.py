...
from ...models.bulk_discount_bucket_request import BulkDiscountBucketRequest
...
def _get_kwargs(
    *,
    body: BulkDiscountBucketRequest,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/admin/bulk_discount_buckets",
    }
