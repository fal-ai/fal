...
from ...models.body_admin_detach_team import BodyAdminDetachTeam
...
def _get_kwargs(
    org_user_str: str,
    *,
    body: BodyAdminDetachTeam,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/admin/organizations/{org_user_str}/actions/detach-team",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Detach Team
     ...
     Detach (remove) a team from the organization.
