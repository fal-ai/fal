...
from ...models.body_admin_archive_team import BodyAdminArchiveTeam
...
def _get_kwargs(
    org_user_str: str,
    *,
    body: BodyAdminArchiveTeam,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/admin/organizations/{org_user_str}/actions/archive-team",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Team must be archived before it can be removed.
