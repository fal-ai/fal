...
from ...models.admin_app_request_latency_request_type import AdminAppRequestLatencyRequestType
...
def _get_kwargs(
    ...
    *,
    ...
    request_type: Union[Unset, AdminAppRequestLatencyRequestType] = AdminAppRequestLatencyRequestType.HTTP,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/admin/apps/{user_id}/{app_name}/request-latency",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        request_type (Union[Unset, AdminAppRequestLatencyRequestType]):  Default:
            AdminAppRequestLatencyRequestType.HTTP.
